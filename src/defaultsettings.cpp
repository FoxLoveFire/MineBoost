...
void set_default_settings()
{
	...
	//Menu
	settings->setDefault("menu_font", "FM_Standard");
	settings->setDefault("menu_bg_color", "(45, 45, 68)");
	settings->setDefault("menu_bg_color_alpha", "173");
	settings->setDefault("menu_active_bg_color", "(0, 0, 0)");
	settings->setDefault("menu_active_bg_color_alpha", "210");
	settings->setDefault("menu_font_color", "(255, 255, 255)");
	settings->setDefault("menu_font_color_alpha", "195");
	settings->setDefault("menu_selected_font_color", "(255, 255, 255)");
	settings->setDefault("menu_selected_font_color_alpha", "235");
	settings->setDefault("menu_head_height", "50");
	settings->setDefault("menu_entry_height", "35");
	settings->setDefault("menu_entry_width", "200");
	// Keymap
